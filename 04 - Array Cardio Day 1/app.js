...
console.log("Bon in 1500's", bornIn1500s);

// Array.prototype.map()
// 2. Give us an array of the inventors' first and last names

const firsLastName = inventors.map(inventor => `${inventor.first} ${inventor.last}`);
console.log("first and last name", firsLastName);

// Array.prototype.sort()
// 3. Sort the inventors by birthdate, oldest to youngest

const sortInventors = inventors.sort((a, b) => a.year - b.year);
console.log("sortInvetnors", sortInventors);

// Array.prototype.reduce()
// 4. How many years did all the inventors live?
const totalYears = inventors.reduce((value, inventor) => value + (inventor.passed - inventor.year), 0);
